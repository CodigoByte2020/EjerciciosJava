...
public class LógicaLavadora {
    ...
    //Con este método podemos obtener el valor de la variable kilos desde otra clase, aunque está este encapsulada de manera privada.
    public int getKilos() {
        return kilos;
    }

    //Con este método podemos establecer un valor a la variable kilos desde otra clase, aunque está este encapsulada de manera privada.
